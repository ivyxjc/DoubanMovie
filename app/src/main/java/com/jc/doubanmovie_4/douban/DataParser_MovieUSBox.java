 ...
 */
public class DataParser_MovieUSBox {
    private static final String TAG="dataParser_MovieUSBox";
...
//        Map<String,String> res=new HashMap<>();
        ...
        try {
            ...
            JSONObject movieNumJSONObject=subjectsJSONArray.getJSONObject(num);
            JSONObject movieJSONObject=movieNumJSONObject.getJSONObject("subject");
            //获取电影名
